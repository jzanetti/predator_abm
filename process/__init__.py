...
PARAMS = {
    "fish": {
            ...
            "vision": {"escape": 5.0, "home": None}, #  6km vision (2 grids * 3km)
    ...
    "penguin": {
            ...
            "vision": {"hunt": 15.0, "escape": 2.0}, # 12 km hunt vision, 6 km escape vision
    ...
    "seal": {
            "energy": {"max": 60, "burn_rate": {
                "water": {"walk": 1.0, "run": 3.0}}}, # Added energy dict structure                           # 120 hours equivalent
